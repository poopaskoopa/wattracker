...
// Source: owner decision (TODO: set true in your untracked main.local.bicepparam to let riders wipe their own cloud scope; one switch grants the read identity the scope-wipe deletes AND turns the route on; false is the safe default and the rollback).
