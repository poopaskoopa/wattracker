...
az functionapp show --name "$FUNCTION_APP_NAME" --resource-group "$RESOURCE_GROUP" --query '{name:name,host:properties.defaultHostName,plan:kind,flexSubnet:properties.siteConfig.virtualNetworkSubnetId}' --output json
